...
### Changes
* The [app icon](Images/logos/hap-logo.svg) has been updated
...
* When setting the app up for the first time, the school name is now shown correctly on the login screen
